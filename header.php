      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <div class="d-flex position-relative justify-content-center justify-content-lg-start align-items-center">
            ...
            <a role="button" href="javascript:;" class="btn d-flex login_modal align-items-center justify-content-between btn-link">
              <i class="fal fa-user-circle"></i>
              Login
            </a>
            <a href="javascript:;" class="btn cadastro_modal d-flex align-items-center justify-content-between btn-header-contato">
              <i class="fal fa-user-circle"></i>
              cadastre-se
            </a>
          </div>
